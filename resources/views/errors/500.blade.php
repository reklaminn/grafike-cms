...
<body class="antialiased bg-gray-50 text-gray-900 min-h-screen flex items-center justify-center">
    <div class="max-w-lg w-full text-center px-6">
        <div class="mb-6">
            <span class="text-9xl font-black text-gray-200">500</span>
        </div>
        <h1 class="text-3xl font-bold text-gray-900 mb-3">Sunucu Hatası</h1>
        <p class="text-gray-500 mb-8">Bir şeyler yanlış gitti. Lütfen daha sonra tekrar deneyin.</p>
